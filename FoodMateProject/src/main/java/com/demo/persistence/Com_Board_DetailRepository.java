...
public interface Com_Board_DetailRepository extends JpaRepository<Com_Board_Detail, Integer> {
	...
	// 제목으로 검색
	@Query(value="SELECT b.seq , b.idx, b.no_data , b.d_regdate, b.cnt, b.goodpoint FROM Com_Board_Detail b JOIN Com_Recipe m ON b.idx = m.idx WHERE m.rcp_nm LIKE %?1% ", nativeQuery=true)
