...
public class HomeController {
	...
	private static String runningProcess(String selectedKeywords, String excludeIngredients, String dietCalory, String nutrientChoice) {
	    ...
	    File workingDirectory = new File("E:/kmc/cherish-test1/08data");
	    String cmd = "python E:/kmc/cherish-test1/08data/recommend_food.py \"" + selectedKeywords + "\" \"" + excludeIngredients + "\" " + dietCalory + " \"" + nutrientChoice + "\"";
